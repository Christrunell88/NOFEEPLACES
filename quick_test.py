...
response = requests.get('https://rentnocomm.preview.emergentagent.com/api/apartments')
...
search_response = requests.get('https://rentnocomm.preview.emergentagent.com/api/apartments', params={'search_term': 'Gotham West'})
...
hk_response = requests.get('https://rentnocomm.preview.emergentagent.com/api/apartments', params={'search_term': "Hell's Kitchen"})
