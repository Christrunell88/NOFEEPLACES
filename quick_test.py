...
response = requests.get('https://nofee-reborn.preview.emergentagent.com/api/apartments')
...
search_response = requests.get('https://nofee-reborn.preview.emergentagent.com/api/apartments', params={'search_term': 'Gotham West'})
...
hk_response = requests.get('https://nofee-reborn.preview.emergentagent.com/api/apartments', params={'search_term': "Hell's Kitchen"})
