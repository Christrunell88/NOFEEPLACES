...
search_response = requests.get('https://nestio-restore.preview.emergentagent.com/api/apartments', params={'search_term': 'Gotham West'})
...
hk_response = requests.get('https://nestio-restore.preview.emergentagent.com/api/apartments', params={'search_term': "Hell's Kitchen"})
