                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        <input
                          ...
                          value="Checkers080/?"
                          readOnly
                          className="w-full text-xs px-2 py-1 pr-8 bg-white border border-indigo-300 rounded text-indigo-900 font-mono"
                          onClick={(e) => e.target.select()}
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                          className="absolute right-1 top-1/2 -translate-y-1/2 p-1 hover:bg-indigo-100 rounded transition-colors"
