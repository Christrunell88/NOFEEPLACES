...
const AIChatbot = ({ apartmentId = null }) => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] glass-dark rounded-2xl shadow-luxury border border-white/10 z-40 flex flex-col">
          {/* Chat Header */}
          <div className="flex items-center justify-between p-4 border-b border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-slate-100">Places Assistant</h3>
                <p className="text-xs text-slate-400">Ask me anything about rentals</p>
              </div>
            </div>
          </div>
