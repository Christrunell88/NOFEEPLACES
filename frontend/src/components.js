  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden border border-gray-200 group">
        ...
        <div className="p-4">
          {/* Title with teaser for non-authenticated users */}
          <div className="mb-1">
            <h3 className="text-base font-semibold text-gray-900 line-clamp-1 flex items-center gap-2">
              <span>{getDisplayTitle(apartment.title, isAuthenticated)}</span>
              {!isAuthenticated && (
            ...
            {!isAuthenticated && (() => {
              ...
              return (
                ...
                >
                  <span className="text-indigo-700 font-medium">{prompt.emoji} {prompt.text}</span>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    onClick={() => setShowContactModal(true)}
                    className="bg-white border border-gray-300 text-gray-900 py-3 px-4 rounded hover:bg-gray-50 transition-colors font-medium text-sm"
                  >
                    Email Inquiry
                  </button>
                  <button
                ...
                <ShareButton apartment={apartment} className="w-full" />
                <button className="w-full bg-white border border-blue-300 text-blue-600 py-3 px-4 rounded hover:bg-blue-50 transition-colors font-medium flex items-center justify-center gap-2">
