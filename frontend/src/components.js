        ...
        <div className="flex justify-between items-center pt-4 border-t border-white/10">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-500 transition-colors text-xs font-medium hover-lift flex items-center"
            >
            ...
            <button 
              ...
              className="btn-primary text-xs px-4 py-2 hover-lift"
            >
              View Details
