...
export const AuthModal = ({ onClose }) => {
  const [showSocialAuth, setShowSocialAuth] = useState(false); // Changed to false - show email/password first
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    style={{ color: '#1f2937', fontSize: '16px' }}
                    className="w-full px-3 py-2 pr-10 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-900 bg-white"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center justify-center gap-2"
              >
                {loading && (
                ...
                <span>{loading ? 'Signing in...' : (isLogin ? 'Sign In' : 'Sign Up')}</span>
              </button>
            </form>
