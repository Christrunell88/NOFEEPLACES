        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 transform hover:scale-105 transition-transform duration-200">
            ...
            <div className="space-y-4">
              ...
              <Link
                to="/contact"
                className="block w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white text-center py-3 px-6 rounded-lg font-semibold transition-colors"
              >
                Get Personal Help
              </Link>
            </div>
