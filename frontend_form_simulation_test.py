    ...
    edge_cases = [
        {
            ...
            "data": {
                ...
                "priority": "medium",
                "timestamp": datetime.now().isoformat(),
                "url": "https://auth-revamp-8.preview.emergentagent.com/test?special=chars&other=value"
            }
        },
        {
            ...
            "data": {
                ...
                "priority": "low",
                "timestamp": datetime.now().isoformat(),
                "url": "https://auth-revamp-8.preview.emergentagent.com/very/long/url/path/that/might/cause/issues?" + "&".join([f"param{i}=value{i}" for i in range(20)])
            }
        },
        {
