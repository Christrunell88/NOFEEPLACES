...
def diagnose_database_setup():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   API endpoint: https://rentauth-test.preview.emergentagent.com/api")
            print(f"   Total apartments: {prod_count}")
            
            # Check for the specific problem
            cpw_response = requests.get("https://rentauth-test.preview.emergentagent.com/api/apartments",
...
def create_deployment_instructions():
    ...
    print(f"   curl 'https://rentauth-test.preview.emergentagent.com/api/apartments?search=Central+Park+West'")
