...
EMERGENT_REDIRECT_URL = os.environ.get('EMERGENT_REDIRECT_URL', 'https://rental-enhance.preview.emergentagent.com/dashboard')
...
async def register(user_data: UserCreate):
    ...
    # Send new user notification email to placesfirm@gmail.com
    try:
...
PLACES No Fee
        ...
        event.add('attendee', f"MAILTO:placesfirm@gmail.com")
        
        # Organizer
        event.add('organizer', f"MAILTO:placesfirm@gmail.com")
...
async def send_apartment_inquiry(request: ContactRequest):
    ...
    try:
        ...
        • Email us at placesfirm@gmail.com
...
async def update_blog_post(slug: str, updated_post: BlogPost):
    ...
    # Update timestamp
    updated_post.updated_at = datetime.now(timezone.utc).isoformat()
